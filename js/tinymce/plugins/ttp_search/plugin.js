...
(function() {
	...
	function Plugin(editor) {
	    var searchBoxUtils = editor.settings.searchBox;
...
//				},
//				onSubmit: function(e) {
//				    console.log("searchValue : " + searchBoxUtils.getText());
//
//					var count, caseState, text, wholeWord;
//
//					e.preventDefault();
...
//			});
		...
		self.init = function(ed) {
			ed.addCommand("Ttp_Search", showDialog);
			ed.addCommand("Ttp_Search2", showDialog);
//			ed.shortcuts.add('Meta+F', '', showDialog);
	...
	tinymce.PluginManager.add('ttp_search', Plugin);
})();
